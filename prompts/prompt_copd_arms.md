Extract only the study design metadata from this COPD clinical trial paper.
...
- `arm_labels`: Brief descriptions of each arm (e.g., `"usual care"`, `"exercise training"`, `"telemonitoring"`)
